...
2. 运行训练脚本。
   ...
   - 单卡训练性能
     ...
     ```
     bash test/train_yolov8_preformance_1p.sh  # yolov8 1p_performance
     ```
...
| NAME     | mAP50 |  mAP50-95   | FPS | Torch_Version |
| :-----:  | :---:  |:------:|:--------:| :------: |
| 1p-竞品A  | 0.493 | 0.351 |    157.1    |    2.1 |
| 1p-NPU | 0.49 |  0.349   |    48.4    |      2.1      |
